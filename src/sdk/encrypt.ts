 ...
 * @param {TfheCompressedPublicKey} publicKey - The public key used for encryption.
...
export const encrypt_bool = (
  ...
  const encrypted = FheBool.encrypt_with_compressed_public_key(
    value,
    publicKey,
  );
  return {
...
export const encrypt_uint8 = (
  ...
  const encrypted = FheUint8.encrypt_with_compressed_public_key(
...
export const encrypt_uint16 = (
  ...
  const encrypted = FheUint16.encrypt_with_compressed_public_key(
    parseInt(bint.toString()),
    publicKey,
  );
...
export const encrypt_uint32 = (
  ...
  const encrypted = FheUint32.encrypt_with_compressed_public_key(
    parseInt(bint.toString()),
    publicKey,
  );
...
export const encrypt_uint64 = (
  ...
  const encrypted = FheUint64.encrypt_with_compressed_public_key(
    bint,
    publicKey,
  );
...
export const encrypt_uint128 = (
  ...
  const encrypted = FheUint128.encrypt_with_compressed_public_key(
    bint,
    publicKey,
  );
...
export const encrypt_uint256 = (
  ...
  const encrypted = FheUint256.encrypt_with_compressed_public_key(
    bint,
    publicKey,
  );
...
export const encrypt_address = (
  ...
  const encrypted = FheUint160.encrypt_with_compressed_public_key(
    value,
    publicKey,
  );
